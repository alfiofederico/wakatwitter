<x-app>
    ...
    <div class="relative">
        ...
        <div class="flex justify-between items-center mb-6">
            ...
            <button type="submit" class="bg-blue-500 rounded-full shadow-md py-2 px-4 text-white text-xs" style="outline:none">{{auth()->user()->following($user) ? 'Unfollow Me' : 'Follow Me'}}</button>
            @endif
            </form>
            </div>
        </div>
